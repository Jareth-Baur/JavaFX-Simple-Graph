...
public class DB extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/school_growth", "root", ""); Statement statement = connection.createStatement(); ResultSet resultSet = statement.executeQuery("SELECT year, number_of_schools FROM school_data")) {
            ...
            while (resultSet.next()) {
                ...
                if (numberOfSchools < minSchools) {
                    minSchools = numberOfSchools;
                }
                if (numberOfSchools > maxSchools) {
